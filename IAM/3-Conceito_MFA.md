...
MFA se trata de um método de autenticação de multifator (Multi-Factor Authentication), servindo como uma autenticação de segundo fator, sendo gerado por três métodos:
1. Via aplicativo de Multi fator;
2. Via Pendrive de autenticação;
3. Via Token de acesso físico.
