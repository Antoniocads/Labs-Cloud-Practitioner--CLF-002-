# O que seria o Organizações no mundo AWS?

O AWS Organizations consiste em afunilar todas as contas dentro de uma única conta. Conseguindo se gerenciar, organizar, tratar do Billing por uma única conta.
